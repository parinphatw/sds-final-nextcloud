...
php occ maintenance:install --database "mysql" --database-name "${database_name}"  --database-user "${database_user}" --database-pass "${database_pass}" --admin-user "${admin_user}" --admin-pass "${admin_pass}" --database-host "${DB_PRIVATE_IP}"
